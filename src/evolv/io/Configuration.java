...
public class Configuration {
	...
	// Brain
	public static final int MEMORY_COUNT = 5;
	...
	// Axon
	public static final double AXON_START_MUTATION_RATE = 0.001;
	...
	public static final double EAT_WHILE_MOVING_INEFFICIENCY_MULTIPLIER = 20.0;
	public static final int ENERGY_HISTORY_LENGTH = 6;
	public static final double FIGHT_ENERGY = 0.05;
	public static final double INJURED_ENERGY = 0.50;
	...
	public static final double MATURE_AGE = 4.00;
	...
	public static final float FIGHT_RANGE = 2.75f;
